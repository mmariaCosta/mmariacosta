export const translations = {
  pt: {
    ...
    sobre: {
      ...
      certs: [
        { name: 'AWS Cloud Practitioner', issuer: 'Amazon Web Services', status: 'studying', year: '2026' },
        { name: 'CompTIA Security+',      issuer: 'CompTIA',              status: 'planned',  year: '2027' },
        { name: 'AWS Security Specialty', issuer: 'Amazon Web Services',  status: 'planned',  year: '2028' },
      ],
    },
    ...
    skills: {
      ...
      softItems: [
        { title: 'Pensamento Analítico',       desc: 'Quebro o problema em partes, entendo o contexto antes de agir e questiono o porquê.' },
        { title: 'Autonomia e Autogestão',     desc: 'Consigo me organizar sozinha, priorizar tarefas e entregar sem precisar de cobrança.' },
        { title: 'Aprendizado Contínuo',       desc: 'Estudo todos os dias — seja uma ferramenta nova, um conceito ou um erro que cometi.' },
        { title: 'Planejamento Estratégico',   desc: 'Penso no impacto a longo prazo antes de decidir. Prefiro construir certo do que refazer depois.' },
        { title: 'Comunicação Direta',         desc: 'Falo claro, pergunto quando não sei e não enrolo quando preciso dizer não.' },
        { title: 'Adaptabilidade Estruturada', desc: 'Lido bem com mudanças sem perder o método — me adapto rápido, mas com processo.' },
      ],
    },
    ...
    cyber: {
      ...
      lab: {
        ...
        vms: [
          { name: 'Kali Linux',       role: 'Distro principal para pentest e análise',        status: 'done' },
          { name: 'Ubuntu Server',    role: 'Alvo de testes — serviços web e SSH',             status: 'done' },
          { name: 'Metasploitable 2', role: 'VM intencionalmente vulnerável para prática',    status: 'building' },
          { name: 'Windows 10 (VM)',  role: 'Análise de logs e eventos do Windows',           status: 'planned' },
        ],
        tools: [
          { name: 'Nmap',                 role: 'Mapeamento de rede e scan de portas',        status: 'done' },
          { name: 'Wireshark',            role: 'Análise de tráfego em tempo real',           status: 'done' },
          { name: 'Burp Suite Community', role: 'Interceptação e análise de aplicações web',  status: 'building' },
          { name: 'Metasploit Framework', role: 'Exploração e pós-exploração',                status: 'building' },
          { name: 'Gobuster',             role: 'Enumeração de diretórios e subdomínios',     status: 'planned' },
          { name: 'John the Ripper',      role: 'Quebra de hashes e auditoria de senhas',     status: 'planned' },
        ],
        exercises: [
          { title: 'Scan de rede local com Nmap',            desc: 'Mapeamento de hosts ativos e portas abertas na rede doméstica.',                  status: 'done' },
          { title: 'Análise de tráfego HTTP com Wireshark',  desc: 'Captura de requisições e identificação de credenciais em texto claro.',           status: 'done' },
          { title: 'Enumeração de diretórios em app web',    desc: 'Uso do Gobuster contra servidor Ubuntu local rodando Apache.',                    status: 'building' },
          { title: 'Explorando vulnerabilidades no Metasploitable', desc: 'Prática de exploits do Metasploit contra serviços vulneráveis.',          status: 'planned' },
        ],
      },
      writeups: {
        ...
        items: [
          {
            ...
            summary: 'Primeiro contato com exploração web. Encontrei um diretório exposto e uma falha de upload que permitiu execução remota. Aprendi o básico de enumeração e como identificar arquivos sensíveis.',
          },
          {
            title: 'Pickle Rick',
            platform: 'TryHackMe',
            ...
            summary: 'Desafio temático com foco em análise de código-fonte e comandos via web shell. Reforcei a importância de ler o HTML da página e de reconhecer padrões de injeção de comando.',
          },
          {
            ...
            difficulty: 'easy',
            date: '2026-05',
            url: 'https://tryhackme.com/module/nmap',
            summary: 'Módulo completo sobre descoberta de hosts com Nmap. Pratiquei as principais flags, tipos de scan e interpretação de resultados em ambientes controlados.',
          },
          {
            ...
            summary: 'Estudo aprofundado de SQL Injection. Entendi como payloads simples exploram consultas mal construídas e como prepared statements previnem o problema desde a raiz.',
          },
          {
            ...
            summary: 'Exploração da vulnerabilidade MS17-010 (EternalBlue) em Windows 7. Um dos desafios mais marcantes — vi de perto o impacto de um sistema desatualizado.',
          },
          {
            ...
            summary: 'CTF com foco em brute force e escalação de privilégios no Linux. Aprendi a usar o Hydra contra SSH e a identificar binários SUID mal configurados.',
          },
        ],
      },
      notes: {
        ...
        items: [
          {
            title: 'O que é o OWASP Top 10',
            date: '2026-03-15',
            tags: ['OWASP', 'Web'],
            excerpt: 'As 10 principais categorias de vulnerabilidades em aplicações web. É um documento vivo, atualizado a cada 3-4 anos, que serve de guia para devs e profissionais de segurança.',
            url: '#',
          },
          {
            title: 'Diferença entre IDS e IPS',
            date: '2026-04-02',
            tags: ['Redes', 'Blue Team'],
            excerpt: 'IDS monitora e alerta. IPS monitora e bloqueia. Ambos analisam tráfego, mas com posturas diferentes — um é passivo, o outro é ativo. Ferramentas comuns: Snort, Suricata, Zeek.',
            url: '#',
          },
          {
            title: 'Simétrico vs Assimétrico',
            date: '2026-04-20',
            tags: ['Criptografia'],
            excerpt: 'Simétrico usa a mesma chave pra encriptar e decriptar (AES). Assimétrico usa par de chaves — pública pra encriptar, privada pra decriptar (RSA). Cada um tem seu caso de uso.',
            url: '#',
          },
          {
            title: 'O que é um SOC',
            date: '2026-05-08',
            tags: ['Blue Team', 'Carreira'],
            excerpt: 'Security Operations Center — time dedicado a monitorar, detectar e responder a incidentes de segurança em tempo real. Trabalha com SIEM, threat intelligence e playbooks de resposta.',
            url: '#',
          },
          {
            title: 'Escalação de privilégios no Linux',
            date: '2026-06-12',
            tags: ['Linux', 'Pentest'],
            excerpt: 'Técnicas comuns: binários SUID mal configurados, cron jobs exploráveis, arquivos com permissões frouxas, sudo sem senha. Sempre vale começar por `sudo -l` e `find / -perm -4000`.',
            url: '#',
          },
          {
            title: 'SQL Injection em 5 minutos',
            date: '2026-07-03',
            tags: ['Web', 'OWASP'],
            excerpt: 'Quando input do usuário vai direto pra query SQL sem sanitização. Payload clássico: `\' OR 1=1--`. Prevenção: prepared statements, validação de input, WAF como camada extra.',
            url: '#',
          },
        ],
      },
  ...
  en: {
    ...
    skills: {
      ...
      softItems: [
        { title: 'Analytical Thinking',        desc: 'I break the problem into parts, understand the context before acting and always question the why.' },
        { title: 'Autonomy & Self-Management', desc: 'I can organize myself, prioritize tasks and deliver without needing to be chased.' },
        { title: 'Continuous Learning',        desc: "I study every day — whether it's a new tool, a concept or a mistake I made." },
        { title: 'Strategic Planning',         desc: "I think about long-term impact before deciding. I'd rather build it right than redo it later." },
        { title: 'Direct Communication',       desc: "I speak clearly, ask when I don't know and don't dance around when I need to say no." },
        { title: 'Structured Adaptability',    desc: 'I handle change well without losing method — I adapt fast, but with process.' },
      ],
    },
    ...
    cyber: {
      ...
      lab: {
        ...
        vms: [
          { name: 'Kali Linux',       role: 'Main distro for pentest and analysis',     status: 'done' },
          { name: 'Ubuntu Server',    role: 'Target — web services and SSH',            status: 'done' },
          { name: 'Metasploitable 2', role: 'Intentionally vulnerable VM for practice', status: 'building' },
          { name: 'Windows 10 (VM)',  role: 'Log and event analysis on Windows',        status: 'planned' },
        ],
        tools: [
          { name: 'Nmap',                 role: 'Network mapping and port scanning',     status: 'done' },
          { name: 'Wireshark',            role: 'Real-time traffic analysis',            status: 'done' },
          { name: 'Burp Suite Community', role: 'Web app interception and analysis',     status: 'building' },
          { name: 'Metasploit Framework', role: 'Exploitation and post-exploitation',    status: 'building' },
          { name: 'Gobuster',             role: 'Directory and subdomain enumeration',   status: 'planned' },
          { name: 'John the Ripper',      role: 'Hash cracking and password auditing',   status: 'planned' },
        ],
        exercises: [
          { title: 'Local network scan with Nmap',         desc: 'Mapping active hosts and open ports at home.',              status: 'done' },
          { title: 'HTTP traffic analysis with Wireshark', desc: 'Capturing requests and spotting plain-text credentials.',   status: 'done' },
          { title: 'Directory enumeration on a web app',   desc: 'Using Gobuster against a local Ubuntu server running Apache.', status: 'building' },
          { title: 'Exploiting Metasploitable vulns',      desc: 'Practicing Metasploit exploits against vulnerable services.', status: 'planned' },
        ],
      },
      writeups: {
        ...
        items: [
          {
            ...
            date: '2026-03',
            url: 'https://tryhackme.com/room/simplectf',
            summary: 'First hands-on with web exploitation. Found an exposed directory and an upload flaw that led to remote code execution.',
          },
          {
            title: 'Pickle Rick',
            platform: 'TryHackMe',
            ...
            date: '2026-04',
            url: 'https://tryhackme.com/room/picklerick',
            summary: 'Themed challenge focused on source code analysis and command execution via web shell.',
          },
          {
            title: 'Nmap Live Host Discovery',
            platform: 'TryHackMe',
            ...
            date: '2026-05',
            url: 'https://tryhackme.com/module/nmap',
            summary: 'Full module on host discovery with Nmap. Practiced key flags, scan types and result interpretation.',
          },
          {
            title: 'OWASP Top 10 — Injection',
            platform: 'TryHackMe',
            ...
            date: '2026-06',
            url: 'https://tryhackme.com/room/owasptop10',
            summary: 'Deep dive into SQL Injection. Understood how simple payloads exploit poorly built queries and how prepared statements prevent it.',
          },
          {
            title: 'Blue (EternalBlue)',
            platform: 'TryHackMe',
            ...
            date: '2026-07',
            url: 'https://tryhackme.com/room/blue',
            summary: 'Exploiting MS17-010 (EternalBlue) on Windows 7. Saw first-hand the impact of an unpatched system.',
          },
          {
            title: 'Brooklyn Nine-Nine',
            platform: 'TryHackMe',
            ...
            date: '2026-08',
            url: 'https://tryhackme.com/room/brooklynninenine',
            summary: 'CTF focused on brute force and Linux privilege escalation. Used Hydra against SSH and found misconfigured SUID binaries.',
          },
        ],
      },
      notes: {
        ...
        items: [
          {
            ...
            date: '2026-03-15',
            tags: ['OWASP', 'Web'],
            excerpt: 'The 10 main categories of web application vulnerabilities. A living document, updated every 3-4 years, serving as a guide for devs and security pros.',
            url: '#',
          },
          {
            title: 'Difference between IDS and IPS',
            date: '2026-04-02',
            tags: ['Networking', 'Blue Team'],
            excerpt: 'IDS monitors and alerts. IPS monitors and blocks. Both analyze traffic but with different postures — one is passive, the other active.',
            url: '#',
          },
          {
            ...
            date: '2026-04-20',
            tags: ['Cryptography'],
            excerpt: 'Symmetric uses the same key to encrypt and decrypt (AES). Asymmetric uses a key pair — public to encrypt, private to decrypt (RSA).',
            url: '#',
          },
          {
            title: 'What is a SOC',
            date: '2026-05-08',
            tags: ['Blue Team', 'Career'],
            excerpt: 'Security Operations Center — a team dedicated to monitoring, detecting and responding to security incidents in real time.',
            url: '#',
          },
          {
            ...
            date: '2026-06-12',
            tags: ['Linux', 'Pentest'],
            excerpt: 'Common techniques: misconfigured SUID binaries, exploitable cron jobs, loose permissions, passwordless sudo. Always start with `sudo -l` and `find / -perm -4000`.',
            url: '#',
          },
          {
            title: 'SQL Injection in 5 minutes',
            date: '2026-07-03',
            tags: ['Web', 'OWASP'],
            excerpt: "When user input goes straight to a SQL query without sanitization. Classic payload: `' OR 1=1--`. Prevention: prepared statements, input validation, WAF as an extra layer.",
            url: '#',
          },
        ],
      },
